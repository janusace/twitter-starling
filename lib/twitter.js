 ...
 *						ƒcredentials and specify which to use for each query, or use round-
 *						robin.
 *						
...
Statuses = function(theparent) {
	...
	this.create =	new Statuses_create(this.parent);
...
Statuses_create = function(theparent) {
...
Retweets = function(theparent) {
	...
	this.timeline =	new Retweets_timeline(this.parent);

	this.statuses =	new Retweets_statuses(this.parent);
...
Retweets_timeline = function(theparent) {
...
Retweets_statuses = function(theparent) {
